...
unsigned hash_func(const struct hash_elem *e, void *aux) {
  HASH_ITEM *tmp = hash_entry(e,HASH_ITEM, elem);
  return hash_int(tmp->data);
}
bool hash_less(const struct hash_elem *a, const struct hash_elem* b, void *aux) {
  HASH_ITEM *x = hash_entry(a, HASH_ITEM, elem);
  HASH_ITEM *y = hash_entry(b, HASH_ITEM, elem);
...
void hash_deleter(struct hash_elem *e, void *aux) {
  HASH_ITEM *tmp = hash_entry(e, HASH_ITEM, elem);
  free(tmp);
}
...
void hash_square(struct hash_elem *e, void *aux) {
  HASH_ITEM *sq_item = hash_entry(e, HASH_ITEM, elem);
  sq_item->data = sq_item->data * sq_item->data;
}
void hash_triple(struct hash_elem *e, void *aux) {
  HASH_ITEM *tri_item = hash_entry(e, HASH_ITEM, elem);
  tri_item->data = tri_item->data * tri_item->data * tri_item->data;
}
